defmodule Skuld.Effects.DB.Batch do
  @moduledoc """
  Batched database read effect using FiberPool.

  This module implements batchable read operations using the FiberPool's
  batching infrastructure. Multiple concurrent `fetch` operations for the
  same schema are automatically batched into a single query.
...
defmodule Skuld.Effects.DB.Batch.Executors do
  ...
  @doc """
  Executor for `DB.Batch.Fetch` operations.
  ...
  @doc """
  Executor for `DB.Batch.FetchAll` operations.
