defmodule Skuld.Effects.Parallel do
  ...
  def_simple_op all(comps)
  def_simple_op race(comps)
  def_simple_op parallel_map(items, fun)

  @all_op @__all_op__
  @race_op @__race_op__
  @parallel_map_op @__parallel_map_op__
  ...
  def with_handler(comp) do
    ...
    |> Comp.with_handler(@__sig__, &handle/3)
  end
  ...
  def handle({@all_op, comps}, env, k) do
  ...
  def handle({@race_op, comps}, env, k) do
    sup = Env.get_state!(env, @supervisor_key)
  ...
  def handle({@parallel_map_op, items, fun}, env, k) do
    sup = Env.get_state!(env, @supervisor_key)
  ...
  def with_sequential_handler(comp) do
    Comp.with_handler(comp, @__sig__, &handle_sequential/3)
  end

  defp handle_sequential({@all_op, comps}, env, k) do
  ...
  defp handle_sequential({@race_op, comps}, env, k) do
  ...
  defp handle_sequential({@parallel_map_op, items, fun}, env, k) do
