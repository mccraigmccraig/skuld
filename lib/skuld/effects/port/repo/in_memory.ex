...
if Code.ensure_loaded?(Ecto) do
  defmodule Skuld.Effects.Port.Repo.InMemory do
    ...
    defp dispatch(Repo.Effectful, :get, [queryable, id] = args, store) do
    ...
    defp dispatch(Repo.Effectful, :get_by, args, store),
      do: dispatch_via_fallback(:get_by, args, store)

    defp dispatch(Repo.Effectful, :get_by!, args, store),
      do: dispatch_via_fallback(:get_by!, args, store)

    defp dispatch(Repo.Effectful, :one, args, store),
      do: dispatch_via_fallback(:one, args, store)

    defp dispatch(Repo.Effectful, :one!, args, store),
      do: dispatch_via_fallback(:one!, args, store)

    defp dispatch(Repo.Effectful, :all, args, store),
      do: dispatch_via_fallback(:all, args, store)

    defp dispatch(Repo.Effectful, :exists?, args, store),
      do: dispatch_via_fallback(:exists?, args, store)

    defp dispatch(Repo.Effectful, :aggregate, args, store),
    ...
    defp dispatch(Repo.Effectful, :delete_all, args, store),
