...
<!-- nav:header:start -->
[< EffectLogger & SerializableCoroutine](effectlogger.md) | [Up: Effects](effectlogger.md) | [Index](../../README.md) | [Durable Computation >](../../../skuld/docs/recipes/durable-computation.md) | [Umbrella →](https://hexdocs.pm/skuld/architecture.html)
<!-- nav:header:end -->
