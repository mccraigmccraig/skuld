...
<!-- nav:header:start -->
[< Hexagonal Architecture](hexagonal-architecture.md) | [Up: Recipes](hexagonal-architecture.md) | [Index](../../../../docs/effects/port.md) | [Umbrella →](https://hexdocs.pm/skuld/architecture.html)
<!-- nav:header:end -->
